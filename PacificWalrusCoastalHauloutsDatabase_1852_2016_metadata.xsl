...
<body>
  <h2>Pacific Walrus Coastal Haulouts Database 1852 2016 Metadata</h2>
  <table>
    <tr bgcolor="#6A5ACD">
    ...
    <tr>
      <th bgcolor="#daa520"><strong>Origin</strong></th>
      <td bgcolor="#d9ffb3"><xsl:value-of select="citation/citeinfo/origin/origin"/></td>
    </tr>
    <tr>
      <th width="15%" bgcolor="#daa520"><strong>Origin</strong></th>
      <td bgcolor="#d9ffb3"><xsl:value-of select="citation/citeinfo/origin/origin/origin"/></td>
    </tr>
    <tr>
      <th bgcolor="#daa520"><strong>Origin</strong></th>
      <td bgcolor="#d9ffb3"><xsl:value-of select="citation/citeinfo/origin/origin/origin"/></td>
